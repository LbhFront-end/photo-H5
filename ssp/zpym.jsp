	...
	$(document).ready(function(){
		...
		$("#tp").click(function(){
			...
			$.post("userPicture_PollPicture",{
	        	...
	        	}else if(result.message.trim()=="sspEnd"){
	        		alert("活动已经结束谢谢参与。");
	        		window.location.href="/wxtp/ssp/ymlb.html";
	        	}else if(result.message.trim()=="noLogin"){
		        	window.location.href="https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxec29c56fdbfeaf07&redirect_uri=http%3a%2f%2fzhuhai.hiooy.com%2fwxtp%2fGetUserInfoAction?targetUrl=http://zhuhai.hiooy.com/wxtp/ssp/userPicture_GetPicById?picId="+$("#picId").val()+"&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect";
